...
def clothing_info():
	...
	while keep_adding != "no":
		...
		index = raw_input("\nPlease enter colour index of clothing: ")
		clothing[name] = [size,category,index]
...
def billing_info():
	...
	expiration_month = raw_input("\nPlease enter your credit card's expiration month (MM): ")
	expiration_year = raw_input("\nPlease enter your credit card's expiration year (YYYY): ")
